...
<nav class="navbar bg-light navbar-expand-sm sticky-top d-sm-none">
    <div class="container-fluid">
        <a class="navbar-brand fs-3 fw-bold" href="/shop/main">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-bag-heart-fill align-top" viewBox="0 0 16 16" style="color:#308752;">
